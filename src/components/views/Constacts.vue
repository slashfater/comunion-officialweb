				...
				if ( this.$sender.validate( this.user ) ) {
					...
					this.$sender.submit( this.user ).then( response => {
						...
						let success = response > 0,
							...
							message = success ? form.success : form.send_error
					...
					? new TimelineMax( { tweens: [
						...
						new TimelineMax( { tweens: [
							...
							new TimelineMax( { tweens: [
								...
								TweenMax.from( $refs.leftSideLetters, 1.2, { y: offset * .25, force3D: true, ease: Cubic.easeOut } ),

								TweenMax.from( $refs.leftSideLine, 1.2, { y: offset * .25, force3D: true, ease: Cubic.easeOut } ),
								
								TweenMax.allFrom( [ $refs.leftSideCopy, $refs.leftSideAdress ], 1.2, { y: offset * .25, force3D: true, ease: Cubic.easeOut }, .1 )
						...
						new TimelineMax( { tweens: [
							...
							new TimelineMax( { tweens: [
								...
								TweenMax.allFrom( [
									...
									/*$form.warning*/ ], 1.2, { y: offset * .25, force3D: true, ease: Cubic.easeOut }, .1 )
					...
					: new TimelineMax( { tweens: [
						...
						new TimelineMax( { tweens: [
							...
							new TimelineMax( { tweens: [
								...
								TweenMax.from( $refs.rightSideLetters, 1.2, { y: offset * .25, force3D: true, ease: Cubic.easeOut } ),

								TweenMax.from( $refs.rightSideLine, 1.2, { y: offset * .25, force3D: true, ease: Cubic.easeOut } ),
								
								TweenMax.allFrom( [ $refs.rightSideCopy, $refs.rightSideAdress ], 1.2, { y: offset * .25, force3D: true, ease: Cubic.easeOut }, .1 )
